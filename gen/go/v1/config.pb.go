...
type DisplaySettings_DateTimeFormatMode int32

const (
	DisplaySettings_DATE_TIME_FORMAT_BROWSER    DisplaySettings_DateTimeFormatMode = 0 // Use browser's locale (default, current behavior)
	DisplaySettings_DATE_TIME_FORMAT_PREDEFINED DisplaySettings_DateTimeFormatMode = 1 // Use a predefined locale format
	DisplaySettings_DATE_TIME_FORMAT_CUSTOM     DisplaySettings_DateTimeFormatMode = 2 // Use a custom format string
)

// Enum value maps for DisplaySettings_DateTimeFormatMode.
var (
	DisplaySettings_DateTimeFormatMode_name = map[int32]string{
		0: "DATE_TIME_FORMAT_BROWSER",
		1: "DATE_TIME_FORMAT_PREDEFINED",
		2: "DATE_TIME_FORMAT_CUSTOM",
	}
	DisplaySettings_DateTimeFormatMode_value = map[string]int32{
...
func (x DisplaySettings_DateTimeFormatMode) Enum() *DisplaySettings_DateTimeFormatMode {
	p := new(DisplaySettings_DateTimeFormatMode)
	*p = x
	return p
}

func (x DisplaySettings_DateTimeFormatMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DisplaySettings_DateTimeFormatMode) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_config_proto_enumTypes[7].Descriptor()
}

func (DisplaySettings_DateTimeFormatMode) Type() protoreflect.EnumType {
	return &file_v1_config_proto_enumTypes[7]
}

func (x DisplaySettings_DateTimeFormatMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DisplaySettings_DateTimeFormatMode.Descriptor instead.
func (DisplaySettings_DateTimeFormatMode) EnumDescriptor() ([]byte, []int) {
...
type Config struct {
	...
	DisplaySettings *DisplaySettings `protobuf:"bytes,8,opt,name=display_settings,json=displaySettings,proto3" json:"display_settings,omitempty"` // UI display preferences
...
func (x *Config) GetDisplaySettings() *DisplaySettings {
	if x != nil {
...
type DisplaySettings struct {
	state              protoimpl.MessageState             `protogen:"open.v1"`
	DateTimeFormatMode DisplaySettings_DateTimeFormatMode `protobuf:"varint,1,opt,name=date_time_format_mode,json=dateTimeFormatMode,proto3,enum=v1.DisplaySettings_DateTimeFormatMode" json:"date_time_format_mode,omitempty"`
	// For PREDEFINED mode: locale string like "en-US", "fr-FR", "de-DE", "ja-JP", etc.
	DateTimeFormatLocale string `protobuf:"bytes,2,opt,name=date_time_format_locale,json=dateTimeFormatLocale,proto3" json:"date_time_format_locale,omitempty"`
	// For CUSTOM mode: custom format string e.g. "YYYY-MM-DD HH:mm"
	DateTimeFormatCustom string `protobuf:"bytes,3,opt,name=date_time_format_custom,json=dateTimeFormatCustom,proto3" json:"date_time_format_custom,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *DisplaySettings) GetDateTimeFormatMode() DisplaySettings_DateTimeFormatMode {
	if x != nil {
		return x.DateTimeFormatMode
	}
	return DisplaySettings_DATE_TIME_FORMAT_BROWSER
}

func (x *DisplaySettings) GetDateTimeFormatLocale() string {
	if x != nil {
		return x.DateTimeFormatLocale
	}
	return ""
}

func (x *DisplaySettings) GetDateTimeFormatCustom() string {
	if x != nil {
		return x.DateTimeFormatCustom
	}
	return ""
}
...
const file_v1_config_proto_rawDesc = "" +
	"\n" +
	"\x0fv1/config.proto\x12\x02v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x0fv1/crypto.proto\"\x9a\x02\n" +
	"\x06Config\x12\x14\n" +
	...
	"\tmultihost\x18\a \x01(\v2\r.v1.MultihostR\x04sync\x12>\n" +
	"\x10display_settings\x18\b \x01(\v2\x13.v1.DisplaySettingsR\x0fdisplaySettings\"\xcd\x04\n" +
	"\tMultihost\x12*\n" +
	...
	"\n" +
	"\bpassword\"\xcc\x02\n" +
	"\x0fDisplaySettings\x12Y\n" +
	"\x15date_time_format_mode\x18\x01 \x01(\x0e2&.v1.DisplaySettings.DateTimeFormatModeR\x12dateTimeFormatMode\x125\n" +
	"\x17date_time_format_locale\x18\x02 \x01(\tR\x14dateTimeFormatLocale\x125\n" +
	"\x17date_time_format_custom\x18\x03 \x01(\tR\x14dateTimeFormatCustom\"p\n" +
	"\x12DateTimeFormatMode\x12\x1c\n" +
	"\x18DATE_TIME_FORMAT_BROWSER\x10\x00\x12\x1f\n" +
	"\x1bDATE_TIME_FORMAT_PREDEFINED\x10\x01\x12\x1b\n" +
	"\x17DATE_TIME_FORMAT_CUSTOM\x10\x02B,Z*github.com/garethgeorge/backrest/gen/go/v1b\x06proto3"
...
var file_v1_config_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
...
var file_v1_config_proto_goTypes = []any{
	...
	(DisplaySettings_DateTimeFormatMode)(0),    // 7: v1.DisplaySettings.DateTimeFormatMode
	...
	(*Auth)(nil),                               // 18: v1.Auth
	(*User)(nil),                               // 19: v1.User
	(*DisplaySettings)(nil),                    // 20: v1.DisplaySettings
...
var file_v1_config_proto_depIdxs = []int32{
	10, // 0: v1.Config.repos:type_name -> v1.Repo
	11, // 1: v1.Config.plans:type_name -> v1.Plan
	18, // 2: v1.Config.auth:type_name -> v1.Auth
	9,  // 3: v1.Config.multihost:type_name -> v1.Multihost
	20, // 4: v1.Config.display_settings:type_name -> v1.DisplaySettings
	...
	7,  // 32: v1.DisplaySettings.date_time_format_mode:type_name -> v1.DisplaySettings.DateTimeFormatMode
	22, // 33: v1.Multihost.Peer.permissions:type_name -> v1.Multihost.Permission
