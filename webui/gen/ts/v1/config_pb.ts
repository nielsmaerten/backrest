...
export const file_v1_config: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_empty, file_v1_crypto]);
...
export type Config = Message<"v1.Config"> & {
   ...
   *
   * @generated from field: v1.DisplaySettings display_settings = 8;
   */
...
/**
 * DisplaySettings contains UI display preferences that apply to all users.
 *
 * @generated from message v1.DisplaySettings
 */
export type DisplaySettings = Message<"v1.DisplaySettings"> & {
  /**
   * @generated from field: v1.DisplaySettings.DateTimeFormatMode date_time_format_mode = 1;
   */
  dateTimeFormatMode: DisplaySettings_DateTimeFormatMode;

  /**
   * For PREDEFINED mode: locale string like "en-US", "fr-FR", "de-DE", "ja-JP", etc.
   *
   * @generated from field: string date_time_format_locale = 2;
   */
  dateTimeFormatLocale: string;

  /**
   * For CUSTOM mode: custom format string e.g. "YYYY-MM-DD HH:mm"
   *
   * @generated from field: string date_time_format_custom = 3;
   */
  dateTimeFormatCustom: string;
};

/**
 * Describes the message v1.DisplaySettings.
 * Use `create(DisplaySettingsSchema)` to create a new message.
 */
export const DisplaySettingsSchema: GenMessage<DisplaySettings> = /*@__PURE__*/
  messageDesc(file_v1_config, 12);

/**
 * DateTimeFormatMode defines how dates/times should be formatted in the UI.
 *
 * @generated from enum v1.DisplaySettings.DateTimeFormatMode
 */
export enum DisplaySettings_DateTimeFormatMode {
  /**
   * Use browser's locale (default, current behavior)
   *
   * @generated from enum value: DATE_TIME_FORMAT_BROWSER = 0;
   */
  DATE_TIME_FORMAT_BROWSER = 0,

  /**
   * Use a predefined locale format
   *
   * @generated from enum value: DATE_TIME_FORMAT_PREDEFINED = 1;
   */
  DATE_TIME_FORMAT_PREDEFINED = 1,

  /**
   * Use a custom format string
   *
   * @generated from enum value: DATE_TIME_FORMAT_CUSTOM = 2;
   */
  DATE_TIME_FORMAT_CUSTOM = 2,
}

/**
 * Describes the enum v1.DisplaySettings.DateTimeFormatMode.
 */
export const DisplaySettings_DateTimeFormatModeSchema: GenEnum<DisplaySettings_DateTimeFormatMode> = /*@__PURE__*/
